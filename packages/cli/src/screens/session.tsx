...
/*
Session screen khuli
       ↓
NewSession se aaya?  →  prefetched data use karo ✅
       ↓ nahi
Direct URL se aaya?  →  API call karo → data fetch karo
       ↓
Messages map karo → ChatMessage → role dekho → component dikhao
       ↓
USER    → UserMessage   (blue/right)
BOT     → BotMessage    (AI response)
